...
export default function StyleComponent() {
  return (
    <>
      <h1>Style</h1>
      {/* HTML/CSS: 3 cach viet CSS
      c1: trong the => inline 
      c2: trong file thuoc head => internal => <style></style>
      c3: khac file => external => goi bang the link
       */}
      {/* React JS:
       C1: trong the => inline CSS {{}}
       C2: External CSS => viet ra file khac nhung bang import 
       C3: CSS Module => viet ra file khac 
        */}
      <h1>Inline</h1>
      <img
        style={{
